/**
 * Mathematical Calculator for precise decimal calculations
 * Migrated from legacy math.js to React module
 */
...
/**
 * Helper function to create a new MathCalculator instance
 * @param {number} num - Initial number
 * @returns {MathCalculator} New calculator instance
 */
