// Constants and configuration for Toram Fill Stats Simulator
...
export type MaterialType = keyof typeof MATERIAL_NAMES;
export type ItemType = 'w' | 'a'; // weapon or armor